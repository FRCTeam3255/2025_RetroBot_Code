...
public class ConstPoseDrive {
  ...
  static {
    ...
    EXAMPLE_POSE_DRIVE_GROUP.targetPoseGroup = ConstField.FieldElementGroups.PREP_CLOSE_TRENCH_POSE_SET.getAll();
    ...
    PREP_CLOSE_TRENCH_POSE_DRIVE_GROUP.targetPoseGroup = ConstField.FieldElementGroups.RESET_POSE_SET.getAll();
    PREP_CLOSE_TRENCH_POSE_DRIVE_GROUP.snapState = DriverState.PREP_CLOSE_TRENCH_ROTATION_DRIVE;
